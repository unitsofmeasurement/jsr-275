...
public abstract class LinearConverter extends UnitConverter {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6162554778940577274L;
	...
	private static class CompoundLinear extends LinearConverter {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -216541324424381418L;
		
		/**
		 * Holds the first converter.
		 */
		private final LinearConverter firstConverter;
		/**
		 * Holds the second converter.
		 */
		private final LinearConverter secondConverter;
		...
		private CompoundLinear(LinearConverter first, LinearConverter second) {
			this.firstConverter = first;
			this.secondConverter = second;
		}

		@Override
		public LinearConverter inverse() {
			return new CompoundLinear(secondConverter.inverse(), firstConverter.inverse());
		}

		@Override
		public double convert(double value) {
			return secondConverter.convert(firstConverter.convert(value));
		}

		@Override
		public BigDecimal convert(BigDecimal value, MathContext ctx) {
			return secondConverter.convert(firstConverter.convert(value, ctx), ctx);
		}
		...
		public boolean equals(Object cvtr) {
			...
			return (this.firstConverter.equals(that.firstConverter))
					&& (this.secondConverter.equals(that.secondConverter));
		}

		@Override
		public int hashCode() {
			return firstConverter.hashCode() + secondConverter.hashCode();
		}
	}
}