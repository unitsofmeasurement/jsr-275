 ...
 *         double weightInLiter = weight.doubleValue(LITRE); // Compile error, Unit<Mass> required.
 *         [/code]</p>
 *
 ...
 *     with a unit and make it a {@link javax.measure.Measure Measure} (and
 *     a {@link javax.measure.Measurable Measurable} instance).[code]
 *
 ...
 *      [/code]</p>
 *
 * <p> Measures may be formatted (or parsed) using either the
 *     {@link javax.measure.unit.UnitFormat#getStandard standard} unit format
 *     (<a href="http://unitsofmeasure.org/">UCUM</a>  based) or a locale sensitive
 *     format.[code]
 ...
 *
 *         Measure<Pressure> pressure = Measure.valueOf("123.45 N/m2").asType(Pressure.class); // Parse (executes MeasureFormat.getStandard().parse("123.45 N/m2")).
 ...
 *
 *         Measure<Acceleration> acceleration = Measure.valueOf(54321, MICRO(METRES_PER_SQUARE_SECOND));
