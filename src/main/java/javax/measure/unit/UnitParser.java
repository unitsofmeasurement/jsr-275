...
// Parser productions
//
  javax.measure.Unit<?> parseUnit() throws ParseException {
        javax.measure.Unit<?> result;
    result = compoundExpr();
    jj_consume_token(0);
  ...
  Unit<?> compoundExpr() throws ParseException {
        Unit<?> result = javax.measure.Unit.ONE;
        Unit temp = javax.measure.Unit.ONE;
    result = addExpr();
    label_1:
    while (true) {
  ...
  javax.measure.Unit mulExpr() throws ParseException {
        javax.measure.Unit result = javax.measure.Unit.ONE;
        javax.measure.Unit temp = javax.measure.Unit.ONE;
    result = exponentExpr();
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  javax.measure.Unit exponentExpr() throws ParseException {
        javax.measure.Unit result = javax.measure.Unit.ONE;
        javax.measure.Unit temp = javax.measure.Unit.ONE;
    ...
    if (jj_2_2(2147483647)) {
      ...
      result = atomicExpr();
        ...
        {if (true) return result.transform(new javax.measure.unit.LogConverter(base).inverse());}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case OPEN_PAREN:
      case INTEGER:
  ...
  Unit<?> atomicExpr() throws ParseException {
    ...
    case UNIT_IDENTIFIER:
      token = jj_consume_token(UNIT_IDENTIFIER);
        javax.measure.Unit unit = _symbols.getUnit(token.image);
        if (unit == null) {
