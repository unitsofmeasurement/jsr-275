...
/**
 * @version $Revision: 63 $, $Date: 2009-11-18 22:44:39 +0100 (Mi, 18 Nov 2009) $
 * @author $Author: keilw $
 */
public class MeasureConversionTest extends TestCase {
    static final Unit<Length> unit1 = SI.METRE;
    static final Unit<Length> unit2 = NonSI.FOOT;

    public MeasureConversionTest(String testName) {
        super(testName);
    }
    ...
    public void testConvert() {
        try {
            ...
            Measure<Length> m1 = Measure.valueOf(BigDecimal.valueOf(23), unit1);
            //reset = true;

            Measure<Length> m2 = m1.to(unit2, MathContext.DECIMAL32);
